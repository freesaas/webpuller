...
import com.newqur.spider.cache.PageSpider;
	...
	public MainUI() {
		...
		mntmNewMenuItem.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				SystemUtil.openUrl("http://www.newqur.com");
			}
		});
		...
		btnNewButton.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				com.newqur.spider.Global.templateDomain = UrlUtil.getDomain(urls[0]);
		...
		JLabel lblNewLabel = new JLabel("作者：freesaas    微信公众号:freesaas");
		
		JLabel lblNewLabel_1 = new JLabel("开源发布 github.com/freesaas");
