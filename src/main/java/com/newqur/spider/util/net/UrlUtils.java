package com.newqur.spider.util.net;
...
public class UrlUtils {
	...
	/**
	 * 替换掉路径的层级，即替换掉前缀的../  、  ./  、 /
	 * @param path 绝对路径前缀，如 http://www.www.newqur.com/a/
	...
	/**
	 * 根据url地址，获取其访问的文件名字
	 * @param url 目标url，如 http://www.newqur.com/images/a.jpg?a=123
	 ...
	 * @param url 目标url，如 http://www.newqur.com/images/a.jpg
